//This program is supposed to alphabetically organize words or phrases entered one by one 

import java.util.ArrayList;
import java.util.Scanner;

public class Alphabetic_Order_ArrList
{
	public static void main(String[] args)
	{
		Scanner sc = new Scanner(System.in);

		System.out.println("Hey there...\nI am here to help you alphabetically organize your words or phrases in alphabetical order.");
		...
		System.out.print("\nThe alphabetical order of your list of words is: \n" + output.get(0));
	...
	public static ArrayList<String> arrange(ArrayList<String> input)
	{
		...
		do
		{
			for(int i = 0; i < input.size(); i++)
			{
				...
				current = "zzzzzzzzzzzzzzzzzzzzzzzzz";
